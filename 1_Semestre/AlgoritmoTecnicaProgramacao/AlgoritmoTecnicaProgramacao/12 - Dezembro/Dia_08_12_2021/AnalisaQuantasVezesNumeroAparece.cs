...
{
    public class AnalisaQuantasVezesNumeroAparece
    {
        public static void QuantasVezesNumeroApareceVetor()
        {
        ...
        static bool estaPresente(int[] V, int x)
        {
            int i;
        ...
        static void Analise(int[] V)
        {
            ...
            for (i = 0; i < V.Length; i++)
                if (estaPresente(Analisados, V[i]) == false)
                {
